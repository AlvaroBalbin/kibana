...
type: reference
description: "Use the Microsoft Defender for Endpoint connector to perform actions on Microsoft Defender-enrolled hosts."
applies_to:
  stack: ga
  serverless:
    observability: ga
...
## Configure Microsoft Defender for Endpoint [configure-defender]

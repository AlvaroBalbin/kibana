...
type: reference
description: "Use the 1Password connector to list and manage users, including suspending and reactivating them, in a 1Password Enterprise Password Manager account."
applies_to:
  stack: preview 9.4
  serverless: preview
---
...
## Get credentials [one-password-credentials]

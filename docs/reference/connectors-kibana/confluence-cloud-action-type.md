...
API token
:   Your Atlassian API token for authentication. Refer to [Get credentials](#confluence-cloud-credentials) for instructions.
...
## Get credentials [confluence-cloud-credentials]

...
type: reference
description: "Use the GreyNoise connector to detect and classify Internet scanning noise and get context about IP addresses."
applies_to:
  stack: preview 9.3
  serverless: preview
---
...
## Get credentials [greynoise-credentials]

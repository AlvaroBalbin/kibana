...
type: reference
description: "Use the Brave Search connector to search the web for privacy-focused results using the Brave Search API."
applies_to:
  stack: preview 9.3
  serverless: preview
---
...
## Get credentials [brave-search-credentials]

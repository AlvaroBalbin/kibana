...
type: reference
description: "Use the AlienVault OTX connector to retrieve community-driven threat intelligence about indicators such as IP addresses, domains, hashes, and URLs."
applies_to:
  stack: preview 9.3
  serverless: preview
---
...
## Get credentials [alienvault-otx-credentials]

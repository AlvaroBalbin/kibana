...
type: reference
description: "Use the Jina Reader connector to turn web pages into markdown from their URL and search the web for better LLM grounding."
applies_to:
  stack: preview 9.4+
  serverless: preview
---
...
## Get credentials [jina-credentials]

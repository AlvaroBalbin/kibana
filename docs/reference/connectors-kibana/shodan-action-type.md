...
type: reference
description: "Use the Shodan connector to search hosts and services for Internet-wide asset discovery and vulnerability scanning."
applies_to:
  stack: preview 9.3
  serverless: preview
---
...
## Get credentials [shodan-credentials]

...
type: reference
description: "Use the VirusTotal connector to scan files and URLs, analyze domains and IP addresses, and look up threat intelligence."
applies_to:
  stack: preview 9.4
  serverless: preview
---
...
## Get credentials [virustotal-credentials]

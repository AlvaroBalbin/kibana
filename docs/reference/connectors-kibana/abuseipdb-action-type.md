...
type: reference
description: "Use the AbuseIPDB connector to check IP address reputation, look up IP details, and report abusive IP addresses using the AbuseIPDB API."
applies_to:
  stack: preview 9.3
  serverless: preview
---
...
## Get credentials [abuseipdb-credentials]
